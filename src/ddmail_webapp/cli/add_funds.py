...
from ddmail_webapp.models import Account, db
...
def main() -> None:
    ...
    with app.app_context():
        ...
        # Add funds to the account
        account.funds_in_sek += args.amount
        db.session.commit()
        
        print(f"Added {args.amount} SEK to account with payment token {args.payment_token}")
        print(f"New balance: {account.funds_in_sek} SEK")
